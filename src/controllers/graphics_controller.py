...
class GraphicsController:
    def __init__(self, frame, window):
        ...
        self.graphics_view.draw_line("x_line", x_line_start_coords)
        self.graphics_view.draw_line("y_line", y_line_start_coords)
        self.graphics_view.draw_line("z_line", z_line_start_coords)
